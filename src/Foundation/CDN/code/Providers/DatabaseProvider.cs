namespace Sitecore.Foundation.CDN.Providers
{
    ...
    public class DefaultDatabaseProvider : IDatabaseProvider
    {
        ...
        {
            get { return Sitecore.Context.Database ?? this.BaseFactory.GetDatabase(this.DefaultDatabaseName); }
        }
        ...
        {
            get { return Sitecore.Context.ContentDatabase ?? this.BaseFactory.GetDatabase(this.DefaultContentDatabaseName); }
        }
